#
# TILLAC_CVSTAG([$Name: CEXP_Release_2_2_2 $], [pattern])
#
# Strip $Name: CEXP_Release_2_2_2 $ from first argument extracting
...
#
# AC_INIT(package, TILLAC_CVSTAG([$Name: CEXP_Release_2_2_2 $]))
#
...
# and using the macro:
#
# AC_INIT(package, TILLAC_CVSTAG([$Name: CEXP_Release_2_2_2 $],'Release_'))
#
